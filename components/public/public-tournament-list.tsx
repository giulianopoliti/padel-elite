...
import { CalendarDays, Clock3, MapPin, Ticket, ChevronRight } from "lucide-react"
...
const getCategoryLabel = (tournament: PublicTournamentSummary) => tournament.categoryName || tournament.name
